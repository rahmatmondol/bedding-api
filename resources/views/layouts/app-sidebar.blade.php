<div class="section-menu-left">
    ...
    @if (auth()->user()->hasRole('customer') || auth()->user()->hasRole('admin'))
        ...
        <div class="content">
            ...
            <ul class="menu-tab">
                ...
                <li class="tablinks {{ request()->routeIs('auth-booking-list') ? 'active' : '' }}" data-tabs="market">
                    <a href="{{ route('auth-booking-list') }}" wire:navigate>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.2">
                                <path d="M6.75731 9.35159V15.64" stroke="white" stroke-width="1.5"
        ...
        <div class="content">
            <h6>Account</h6>
            <ul class="menu-tab">
                <li class="tablinks {{ request()->routeIs('auth-account-profile') ? 'active' : '' }}" data-tabs="market">
                    <a href="{{ route('auth-account-profile') }}" wire:navigate>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.2">
                                <path d="M6.75731 9.35159V15.64" stroke="white" stroke-width="1.5"
                ...
                <li class="tablinks {{ request()->routeIs('auth-account-notifications') ? 'active' : '' }}"
                    data-tabs="market">
                    <a href="{{ route('auth-account-notifications') }}" wire:navigate.hover>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.2">
                                <path d="M6.75731 9.35159V15.64" stroke="white" stroke-width="1.5"
                ...
                <li class="tablinks {{ request()->routeIs('auth-account-messages') ? 'active' : '' }}"
                    data-tabs="market">
                    <a href="{{ route('auth-account-messages') }}" wire:navigate.hover>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.2">
                                <path d="M6.75731 9.35159V15.64" stroke="white" stroke-width="1.5"
    ...
    @if (auth()->user()->hasRole('provider') || auth()->user()->hasRole('admin'))
        {{-- manu for provider and admin --}}
        <div class="content">
            <h6>My Booking</h6>
            <ul class="menu-tab">
                <li class="tablinks {{ request()->routeIs('auth-service-list') ? 'active' : '' }}"
                    data-tabs="market">
                    <a href="{{ route('auth-service-list') }}" wire:navigate.hover>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.2">
                                <path d="M6.75731 9.35159V15.64" stroke="white" stroke-width="1.5"
                ...
                <li class="tablinks {{ request()->routeIs('auth-service-wishlist') ? 'active' : '' }}"
                    data-tabs="market">
                    <a href="{{ route('auth-service-wishlist') }}" wire:navigate.hover>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.2">
                                <path d="M6.75731 9.35159V15.64" stroke="white" stroke-width="1.5"
                ...
                <li class="tablinks {{ request()->routeIs('auth-bid-list') ? 'active' : '' }}"
                    data-tabs="market">
                    <a href="{{ route('auth-bid-list') }}" wire:navigate.hover>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.2">
                                <path d="M6.75731 9.35159V15.64" stroke="white" stroke-width="1.5"
                ...
                <li class="tablinks {{ request()->routeIs('auth-account-profile') ? 'active' : '' }}"
                    data-tabs="market">
                    <a href="{{ route('auth-account-profile') }}" wire:navigate.hover>
                        <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <g opacity="0.2">
                                <path d="M6.75731 9.35159V15.64" stroke="white" stroke-width="1.5"
